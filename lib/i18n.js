...
// const langs = (window.navigator.languages && window.navigator.languages) || []
// const langJa = langs.find(lang => lang === "ja")
// const language = langJa || 'en'

// tested but always returns en-US for me
    ...
    resources: {
      en: {
        translation: {
          ...
          "Registration completed, build your model": "Sign in and enjoy building your own machine learning model!",
          "Next": "next",
        }
      },
      ja: {
        translation: {
          ...
          "Registration completed, build your model": "さっそくログインしてモデルを作ってみましょう",
          "Next": "次へ",
        }
      }
    },
